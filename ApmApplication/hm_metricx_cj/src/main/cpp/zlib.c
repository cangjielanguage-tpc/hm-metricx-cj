...
extern int CJ_ZlibStreamEncode(z_stream *zlibStream, int flushType) { return deflate(zlibStream, flushType); }

extern int CJ_ZlibStreamEncodeFini(z_stream *zlibStream) { return deflateEnd(zlibStream); }
