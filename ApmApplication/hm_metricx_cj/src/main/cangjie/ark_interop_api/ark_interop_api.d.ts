...
export declare interface CustomLib {
    ...
    initPageEventHandler(onDisplay: DisplaySyncInterface, onNavDestinationSwitch: (funcArg0: (funcArgfuncArg0: string) => void) => void, onWindowEvent: (funcArg0: () => void, funcArg1: () => void) => void, reportPageFpsInfo: (funcArg0: FpsEventInfo) => void, reportWindowFpsInfo: (funcArg0: FpsEventInfo) => void): void
